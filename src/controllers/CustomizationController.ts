...
//import { ParameterVo } from '../stores/Parameter'; customization
export class CustomizationController extends BaseController {
  ...
  async create(data:any) {
      ...
      /////API.fhcrm.Parameter.createParameter
       await axios({
            ...
            method:'post',
            url:'/customization/createCustomization',
  ...
  async remove(Ids: string[]) {
    ...
    const listItems = numbers.map((id) => {
      return fetch(this.baseURL()+'/customization/removeCustomization/'+id).then(res => res.json())
      .then(d => d);
    });
    ///this.success();
  }
  ...
  async getById(Id:string) {
    ...
    return fetch(this.baseURL()+'/customization/getCustomizationById/'+Id).then(res => res.json())
            .then(d => d);
  ...
  async getAll(fhevent:any) {
    ...
    return fetch(this.baseURL()+'/customization/getCustomizationAll?'+fhurl).then(res => res.json())
            .then(d => d);
  ...
  async getAllView() {
    ...
    return fetch(this.baseURL()+'/customization/getCustomizationAllView').then(res => res.json())
            .then(d => d);
  }
  ...
  async update(data:any,Id:string,userToken:string) {
    ...
    await axios({
         baseURL:this.baseURL(),
         method:'put',
         url:'/customization/updateCustomization/'+Id,
