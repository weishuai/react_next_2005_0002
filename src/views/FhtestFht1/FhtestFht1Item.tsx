...
export const FhtestFht1ItemAdd =({ Id, Mode }: FhtestFht1ItemProps) => {
  ...
  const [FHid, setFHid] = useState('');
    ...
    useEffect(() => {
      ...
      // ctlFhtestFht1.getFhtestFht1All().then((data)=>{
      //     console.log('999data:'+JSON.stringify(data));
      //     setFHUsers(data);
      //   });
      ...
      <tbody>
         ...
         <tr>
          ...
          <td >
                <div className="p-field p-col-12 p-md-6">
                <div style={{height:10}}> </div>
                <Button label="取消" onClick={(e) => {replace("/fhtestfht1");}}  style={{backgroundColor:'#4682B4'}}  />
                </div>
          </td>
          <td ></td>
          <td>
      ...
      if(fhcount==0)
      {
        ...
        getFHproducts().then((data)=>{
          ...
          ctlFhtestFht1.getFhtestFht1ById(Id).then((data)=>{
            ...
            // console.log('data_myfhF5:'+JSON.stringify(myfhF5));
            // console.log('data_fhmodel["fhF50"]:'+JSON.stringify(myfhF5["id"]));
            // console.log('data_fhmodel["fhF51"]:'+JSON.stringify(myfhF5["name"]));
            // items.push({code:myfhF5["id"],name:myfhF5["name"]});
            setfhF5(myfhF5["id"]);
