...
import { FhtestFht1Controller2 } from '../../controllers/FhtestFht1Controller2my';
            ...
            <MyDataTable
                    ...
                    FHColumns={
                        [
                            ...
                            <Column header ={t("fhtestFht1.fhname")}  field = "fhname" filter filterPlaceholder="设备编码"   sortable={false} key =  {10005}  ></Column>,
                            <Column header ={t("fhtestFht1.fhF1")} field = "fhF1" filter filterPlaceholder="设备名称"   sortable={false}  key =  {10006}  ></Column>,
                            ...
                            <Column   header={t('dataTable.Info')} field="id"  sortable={false}  alignHeader="center" headerStyle={{minWidth: '16rem'}} style={{ width: '16rem'}}   body={(rowData) => {
                                return(
                                    <div style={{textAlign:'center',flex:1}}>
                                     <Button label={t('dataTable.HeadInfo')} style={{height:25}} className="p-button-sm p-button-info"  onClick={()=>{replace("/myfhtestfht2/"+rowData.id+"/2");}}></Button>                                        
                                     <Button label={t('dataTable.Edit')}  style={{height:25}}  className="p-button-sm p-button-secondary"  onClick={()=>{replace("/myfhtestfht2/"+rowData.id+"/1");}} />
