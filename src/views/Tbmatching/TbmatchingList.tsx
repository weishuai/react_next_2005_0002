...
export const TbmatchingList = () => {
    ...
    const ctlTbmatching = new TbmatchingController();
    const ctlTiems=new TimesController();
    const { pathname, push,replace } = useRouter();
    const [val, setVal] = useState("");
    var fhcount=0;
    const fn=async (fhevent)=>{
        await   ctlTbmatching.getTbmatchingAll(fhevent).then(data =>{

             ctlTbmatching.getTbmatchingAll_count(fhevent).then(dataok =>{
    ...
    return (
       ...
       <div >
         ...
         <span className="p-buttonset">
            ...
            <Button label={t('dataTable.Save')} icon="pi pi-check"  onClick={()=>{replace("/tbmatching/0/0");}} style={{backgroundColor:'#4682B4'}}  />
            <span style={{width:100}}></span>
            <Button label={t('dataTable.Delete')} icon="pi pi-trash" style={{backgroundColor:'#4682B4'}} onClick={()=>{
                for(let item of FHids)
                {
                    ctlTbmatching.removeTbmatching([item.id]).then(()=>{
                     fn(fhevent);
                    });
                }
                //replace("/pages/tbmatching");
                }}   />
            <span style={{width:100}}></span>
            ...
            <MyDataTable
                    ...
                    FHColumns={
                        [
                            ...
                            <Column header ={t("tbmatching.fhname")}  field = "fhname" sortable key =  {10005}  ></Column>,
                            <Column header ={t("tbmatching.fhdate")} field = "fhdate" sortable key =  {10006}  ></Column>,
                            <Column header ={t("tbmatching.sampleDate")} field = "sampleDate" sortable key =  {10007}  ></Column>,
                            <Column header ={t("tbmatching.documentNumber")}  field = "documentNumber" sortable key =  {10008}  ></Column>,
                            <Column header ={t("tbmatching.customerCode")}  field = "customerCode" sortable key =  {10009}  ></Column>,
                            <Column header ={t("tbmatching.customerName")} field = "customerName" sortable key =  {100010}  ></Column>,
                            <Column header ={t("tbmatching.sampleName")}  field = "sampleName" sortable key =  {100011}  ></Column>,
                            <Column header ={t("tbmatching.numbe")} field = "numbe" sortable key =  {100012}  ></Column>,
                            <Column header ={t("tbmatching.component")}  field = "component" sortable key =  {100013}  ></Column>,
                            <Column header ={t("tbmatching.appearanceStyle")}  field = "appearanceStyle" sortable key =  {100014}  ></Column>,
                            <Column header ={t("tbmatching.requirements")}  field = "requirements" sortable key =  {100015}  ></Column>,
                            <Column header ={t("tbmatching.technology")}  field = "technology" sortable key =  {100016}  ></Column>,
                            <Column header ={t("tbmatching.mycheck")} field = "mycheck" sortable key =  {100017}  ></Column>,
                            <Column header ={t("tbmatching.registration")} field = "registration" sortable key =  {100018}  ></Column>,
                            <Column header ={t("tbmatching.quotation")} field = "quotation" sortable key =  {100019}  ></Column>,
                            <Column header ={t("tbmatching.manufacturingOrders")} field = "manufacturingOrders" sortable key =  {100020}  ></Column>,
                          ...
                          <Column  header={t('dataTable.Info')} field="id"   body={(rowData) => {
                                return(
                                    <React.Fragment>
                                     <Button label={t('dataTable.HeadInfo')} style={{height:25}} className="p-button-sm p-button-info"  onClick={()=>{replace("/pages/tbmatching/"+rowData.id+"/2");}}></Button>
                                     <Button label={t('dataTable.Edit')}  style={{height:25}}  className="p-button-sm p-button-secondary"  onClick={()=>{replace("/pages/tbmatching/"+rowData.id+"/1");}} />
                                     <Button label={t('dataTable.Delete')}  style={{height:25}}  className="p-button-sm p-button-danger" onClick={() => {
                                         ctlTbmatching.removeTbmatching([rowData.id]).then(()=>{
                                             // fn(fhevent);
                                            });
