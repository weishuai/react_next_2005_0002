...
export const List = () => {
    ...
    const ctlmain = new ExchangeRateController();
    ...
    return (
       ...
       <div >
         ...
         <span className="p-buttonset">
            ...
            <Button label={t('dataTable.Save')} icon="pi pi-check"  onClick={()=>{replace("/exchangeRate/0/0");}} style={{backgroundColor:'#4682B4'}}  />
            <span style={{width:100}}></span>
                    ...
                    FHColumns={
                        [
                            ...
                            <Column  header={t('dataTable.Info')} field="id"   body={(rowData) => {
                                return(
                                    <React.Fragment>
                                     <Button label={t('dataTable.HeadInfo')} style={{height:25}} className="p-button-sm p-button-info"  onClick={()=>{replace("/exchangeRate/"+rowData.id+"/2");}}></Button>
                                    </React.Fragment>
                                ); 
                            }             
                            ...
                            <Column  header={t('dataTable.Edit')}  field="id"   body={(rowData) => {
                                return(
                                    <React.Fragment>
                                     <Button label={t('dataTable.Edit')}  style={{height:25}}  className="p-button-sm p-button-secondary"  onClick={()=>{replace("/exchangeRate/"+rowData.id+"/1");}} />
